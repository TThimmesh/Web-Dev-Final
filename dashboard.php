...
if (isset($_GET['delete_course_id'])) {
    ...
    // Redirect to the dashboard to show updated courses
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_course'])) {
    ...
    if ($title && $description && $image_url) {
        try {
            // Prepare the SQL query to insert a new course
            ...
            <div class="course-card">
                ...
                <div class="course-card-body">
                    ...
                    <a href="course_details.php?course_id=<?php echo $course['course_id']; ?>"
                       class="cta-button">View Details</a>
                    <a href="dashboard.php?delete_course_id=<?php echo $course['course_id']; ?>"
                       class="cta-button" onclick="return confirm('Are you sure you want to delete this course?');">Delete Course</a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
